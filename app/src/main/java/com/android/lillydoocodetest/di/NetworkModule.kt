package com.android.lillydoocodetest.di
...
import com.android.lillydoocodetest.data.repository.JokesRepositoryImp
import com.android.lillydoocodetest.domain.repository.JokesRepository
import com.android.lillydoocodetest.util.Constants
...
class NetworkModule {
    ...
    fun provideManufacturerRepository(
        ...
        return JokesRepositoryImp(retrofitService)
    }
}