...
open class PreferenceManager constructor(context: Context) : IPreferenceHelper {
    private val PREFS_NAME = "SharedPreferenceJokes"
    private var preferences: SharedPreferences = context.getSharedPreferences(PREFS_NAME, Context.MODE_PRIVATE)
    override fun setAppOpenedCountKey(count: Int) {
        preferences[APP_OPENED_COUNT_KEY] = count
    }
    override fun getAppOpenedCountKey(): Int {
        return preferences[APP_OPENED_COUNT_KEY] ?: 0
    }
    override fun clearPrefs() {
        preferences.edit().clear().apply()
    }
    companion object {
        const val APP_OPENED_COUNT_KEY = "app_opened_count_key"
    }
}
/**
